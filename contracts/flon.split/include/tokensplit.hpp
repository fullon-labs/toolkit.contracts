...
class [[eosio::contract("flon.split")]] tokensplit: public eosio::contract {
private:
...
public:
    ...
    ACTION notifyplan( const plan_event_t& trace);

    [[eosio::on_notify("*::transfer")]]
    void ontransfer(const name& from, const name& to, const asset& quant, const string& memo);

    using notifyplan_action = eosio::action_wrapper<"notifyplan"_n, &tokensplit::notifyplan>; 
