#include <flon.applybp/flon.applybp.hpp>
...
#define CHECKC(exp, code, msg) \
   ...
   void flon_applybp::init( const name& admin){
      require_auth( _self );
   ...
   void flon_applybp::applybp(const name& owner,
   ...
   void flon_applybp::updatebp(const name& owner,
                              const string& logo_uri,
                              const string& org_name,
                              const string& org_info,
                              const name& dao_code,
   ...
   void flon_applybp::addproducer(const name& submiter,
                              const name& owner,
                              const string& logo_uri,
                              const string& org_name,
                              const string& org_info,
   ...
   void flon_applybp::setstatus( const name& submiter, const name& owner, const name& status){
   ...
   void flon_applybp::_set_producer(const name& owner,
                              const string& logo_uri,
                              const string& org_name,
                              const string& org_info,
                              const name& dao_code,
                              ...
                              const string& manifesto,
                              const string& issuance_plan){
      CHECKC( is_account(owner), err::ACCOUNT_INVALID, "owner invalid:" + owner.to_string())
